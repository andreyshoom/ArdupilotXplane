...
void GCS_MAVLINK_Plane::send_attitude() const
{
    ...
    r = GCS_roll_Xplane/57.2958;//0.261799;
    p = GCS_pitch_Xplane/57.2958;//0.523599;
    y = GCS_hding_mag_Xplane/57.2958;//0.767945;
    // roll_Xplane;
    // pitch_Xplane;
    // hding_mag_Xplane;
...
void GCS_MAVLINK_Plane::send_position_target_global_int()
{
    ...
    // GCS_pitch_Xplane = plane.set_xpl_var(1);
    GCS_pitch_Xplane        = plane.pitch_Xplane;
    GCS_roll_Xplane         = plane.roll_Xplane;
    GCS_hding_mag_Xplane    = plane.hding_mag_Xplane;
    GCS_trueSpd_Xplane      = plane.trueSpd_Xplane;
    AP_AHRS &ahrs = AP::ahrs();
        ...
        1,
        3,//status(0),
        plane.lat_Xplane*10000000,//300000000.0,//loc.lat,        // in 1E7 degrees
        plane.lon_Xplane*10000000,//300000000.0,//loc.lng,        // in 1E7 degrees
        plane.alt_Xplane*1000,//88000,//loc.alt * 10UL, // in mm
        0,
        0,
        3000,//ground_speed(0)*100,  // cm/s
        plane.hding_true_Xplane*100, // 1/100 degrees,
        0,
        0,                    // TODO: Elipsoid height in mm
        0 * 1000,          // one-sigma standard deviation in mm
        0 * 1000,          // one-sigma standard deviation in mm
        0 * 1000,          // one-sigma standard deviation in mm/s
        0,                    // TODO one-sigma heading accuracy standard deviation
        plane.hding_mag_Xplane);
        
        mavlink_msg_vfr_hud_send(
        chan,
        plane.trueSpd_Xplane,//20,//vfr_hud_airspeed(),
        plane.GroundSpd_Xplane,//30,//ahrs.groundspeed(),
