...
/// strat my addition
	// if(senddata_t3_gps == true){
		...
		// senddata_t3_gps = false;
	// }
	gps_inttt = i;
	//hal.uartD->printf("     GPS.i = %u      ", gps_inttt);
/// end my addition
...
///
	// hal.uartD->printf("     baro.i = %u      ", baro_instance);
	// hal.uartD->printf("     baro.alt = %f      ", baro.get_altitude(baro_instance));
///
