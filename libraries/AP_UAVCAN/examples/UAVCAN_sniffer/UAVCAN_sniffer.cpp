...
void UAVCAN_sniffer::init(void)
{
    ...
    can_mgr->begin(500000, interface);
...
void UAVCAN_sniffer::loop(void)
{
	...
	// AP_UAVCAN ap_uavcan_test;
	
	// const uint8_t data_and[] = {1,2,2,1,3,5,5,3};
	// //const uint8_t *data_t = 5;
	// uint32_t len_t = 8;
	// ap_uavcan_test.send_RTCMStream(data_and, len_t);
}
